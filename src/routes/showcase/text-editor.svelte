<script>
    ...
    $: first = true;
    $: titulek = "Welcome to my text editor!";
    ...
    $: blocks = [
        {
            id: 1,
            content:
                "This is a Notion-like block-based editor developed in Svelte",
            type: "p",
        },
        {
            id: 2,
            content:
                "It supports many different additions to make the writing stand out!",
            type: "callout",
        },
        {
            id: 3,
            content:
                "So feel free to play around! On the left you can find a list of all the commands you can use.",
            type: "citace",
        },
    ];
    $: urlObrazku = "Enter image URL";
    ...
    let autor = "Michal Pavlíček";
    let stitky = [
        { id: 1, color: "blue", nazev: "Liga Mistrů" },
        { id: 2, color: "orange", nazev: "Evropská liga" },
        { id: 1, color: "red", nazev: "La Liga" },
    ];
    ...
    <div id="flex-container">
        ...
        <section>
            <h1
                ...
                on:focus|once={() => {
                    if (titulek == "Welcome to my text editor!") {
                        titulek = "";
                        first = false;
                    }
                }}
                ...
                {:else}
                    ...
                    >
                        <div
                            ...
                            on:focus|once={() => {
                                if (block.content == "Body of the article") {
                                    block.content = "";
                                }
                            }}
                            on:focus={() => {
                        ...
                        >
                            ...
                            >
                                ...
                                {#if block.content == "" || block.content == "Body of the article"}
                                    <div
                                        on:click={() => {
            ...
            <div id="osnova-flex">
                {#if pocetSlov == 1}
                    <span>{pocetSlov} word<br />{pocetZnaku} characters</span>
                {:else if pocetSlov == 2 || pocetSlov == 3 || pocetSlov == 4}
                    <span>{pocetSlov} words<br />{pocetZnaku} characters</span>
                {:else}
